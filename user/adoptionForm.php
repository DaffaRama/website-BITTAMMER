...
<head>
  ...
  <title>BitTamer - Adoption Form</title>
...
<body>
  ...
  <?php 
            ...
            $id = isset($_GET['id']) ? $_GET['id'] : 0; // Pastikan ID tersedia
        $sql = "SELECT * FROM animal WHERE id = $id"; 
        $result = $conn->query($sql);

        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                echo "<a href='../assets/form/BitTamer Adoption Form.docx' download><h1>Download Adoption Form Here</h1></a>";
