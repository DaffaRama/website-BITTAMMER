...
<head>
  ...
  <title>BitTamer - Home</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons gambar logo di title-->
...
<body>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container" data-aos="zoom-in" data-aos-delay="100">
        <div class="col-lg-8" style="text-align: center;">
          <h1>Welcome to <span>BitTamer</span>, <?php echo $_SESSION['user']['username']; ?></h1>
          <h2>Helping animals find their forever homes since 2022!</h2>
        </div>
    </div>
  </section><!-- End Hero -->
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <h3>BitTamer Animal Adoption</h3>
            <p class="fst-italic">
            BitTamer (BT) is a non-profit platform dedicated to connecting abandoned animals with loving new homes.
            </p>
            <ul>
              <li><i class="bi bi-check-circle"></i> We operate as a no-kill adoption platform, ensuring all animals find a safe home.</li>
              <li><i class="bi bi-check-circle"></i> We vaccinate, deworm, and neuter/spay all of the animals in our website</li>
              <li><i class="bi bi-check-circle"></i> Our operations and services are fully supported by the generous donations from animal lovers and our community.</li>
              </ul>
          </div>
        </div>
    ...
    <section id="gallery" class="gallery">
      ...
      <div class="container" data-aos="fade-up">
        <div class="section-title">
          ...
          <p>Successful Adoptions from Our Website</p>
        </div>
      </div>
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>BitTamer</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
