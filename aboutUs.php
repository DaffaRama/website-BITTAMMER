  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex justify-content-center justify-content-md-between">
      ...
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-phone d-flex align-items-center"><span>+62 813-3610-1912</span></i>
        <i class="bi bi-clock d-flex align-items-center ms-4"><span> Senin-Sabtu Jam 08.00 - 16.00</span></i>
      </div>
    ...
    <section id="cta" class="cta">
      <div class="container" data-aos="zoom-in">
        ...
        <div class="text-center">
          <div class="fortxt">
            <p style="text-align: left;">The BT (Bit Tamer ) organize by Three Of Us since 2022. Bit Tamer is a non-profit animal Website that helps the adoption of unwanted animals. However, the currect web system does not display pictures or information about the animals. The adoption process is also done manually at the Office, which can be time wasting and troublesome. It causes less people to want to adopt animals.</p>
          </div>
        <div class="forimage">
          <p>
      ...
      <div class="container" data-aos="zoom-in">
        ...
        <div class="text-center">
          <ol>
            ...
            <li style="text-align: left;">improve the lives of companion animals in Surabaya and assist in humanely managing the population of dogs and cats via education and sterilization.</li> 
  ...
  <section id="contact" class="contact">
    ...
    <section id="cta" class="cta">
      <div class="container" data-aos="zoom-in">
        ...
        <div class="text-center ">
          <p style="text-align: left;">Welcome to BitTamer, your trusted platform for free animal adoption. We are dedicated to connecting animals in need with loving and responsible families. As a non-profit website, BitTamer is driven by a mission to make adoption accessible and simple for everyone while giving animals a second chance at life.</p>
        </div>
      </div>
    </section>
    </div>
  ...
  <section id="contact" class="contact">
    ...
    <section id="cta" class="cta">
      <div class="container" data-aos="zoom-in">
        ...
        <div class="text-center ">
          <p style="text-align: left;">Daffa Rama</p>
          <p style="text-align: left;">M. Aldi</p>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            ...
            <h3>BitTamer</h3>
              <p>
                41, Jalan Arief Rachman Hakim no 2<br>
                60911 Surabaya, Jawa Timur<br><br>
                <strong>Phone:</strong> +62 813-3610-1912<br>
                <strong>Email:</strong> Bittamer.u@gmail.com<br>
              </p>
